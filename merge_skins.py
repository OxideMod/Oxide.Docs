...
def main():
    # File paths
    exporter_file = Path('docs/public/data/exporter_skins-2025-05-27.json')
    skins_file = Path('docs/public/data/skins.json')
    output_file = Path('docs/public/data/merged_skins.json')
    ...
    output_data = {
        'metadata': {
            ...
            'coverage_percentage': round(skins_with_market_data/total_skins*100, 2),
            'source_files': [
                str(exporter_file),
                str(skins_file)
            ]
