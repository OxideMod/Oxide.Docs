...
* `OverlayNonScaled`  same as Overlay layer, scale to resolution but not to client UI scale setting
...
* `UnderNonScaled` same as Under layer, scale to resolution but not to client UI scale setting
