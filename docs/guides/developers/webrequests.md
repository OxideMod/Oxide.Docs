...
The HTTP GET method is used to retrieve a resource, usually represented as XML or JSON<sup><a href="/glossary#json">[3]</a></sup>. HTTP status code 200 (OK) is expected in response to a successful GET request.
